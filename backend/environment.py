...
class TradingStrategyEnv(gym.Env):
    ...
    def __init__(self, new_strategy, strategy_config, virtual_prices, performance_option, max_steps=20):
        ...
        self.performance_option = performance_option
    ...
    def _simulate_performance(self, actual_params):
        ...
        if tradeCount == 0:
            return 0
        if self.performance_option == "successRate":
            return successCount / tradeCount
        elif self.performance_option == "totalTrades":
            return tradeCount
        elif self.performance_option == "avgReturn":
            return sum(avgReturnList) / len(avgReturnList)
        elif self.performance_option == "totalProfit":
            return profitCount
        else:
            return 0
